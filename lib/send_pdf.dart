...
class SendPDF{
  final String accessToken = 'EAAMLzrSztE0BOZBCVx5nFQQfCj5ZB8x6aPa62VeX9wjUjJ3sZCrZC05jO2ZCluSZCJD6vaa9GfQZCQBrJvt37cJ1SY6n3zSeR5pQ2d1U8pnf5LVpjZBjwZBpFhpBW07FuSbbEokP4e8osTkpL2dZClfUV8GkGY5ZC4UG1uI8sZAKnJBQgJzCqvSdTrHmRVWM2MnhizoZCArmsgGKkhyMk1gKTUygZD';
  ...
  sendPDF(File file, String phoneNumber) async{
    ...
    var client = wa;
    var uploadMediaFile = await client.uploadMediaFile(file: file, fileType: "application/pdf");
    if (uploadMediaFile.isSuccess()){
      String? mediaID = uploadMediaFile.mediaId;
      sendPDFWithMediaId(mediaID, phoneNumber);
    }else{
      print('media upload failed Status: ${uploadMediaFile.httpCode}, ErrorMessage: ${uploadMediaFile.errorMessage}, Error: ${uploadMediaFile.error}');
    }
  ...
  sendPDFWithMediaId(String? mediaId, String phoneNumber) async{
    var client = wa;
    var res = await wa.sendTemplate(phoneNumber: phoneNumber, template: 'hello_world', language: 'en_US');
